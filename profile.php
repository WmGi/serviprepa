        ...
        <header id="header">
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active"><a href="indexs.php">Home</a></li>
                        ...
                        <li><a href="indexs.php#about">About Us</a></li>
        ...
        <div class="row">
            <div class="col-md-3 left fixed ">
                ...
                <div class="card">
                    ...
                    <div class="card-content pt20 pb20 profile-header">
                        ...
                        vous devez connecte pour voir les informations
                    </p>";
                        ?> </p>
            ...
            <div class="col-md-9  right">
                <div class="card card1">
                    <div class="box1">
                        <img src="/images/chemical-reaction-AI.jpg" alt="">
                        <h3 class="title">PC</h3>
                        <ul class="icon">
                            <li><a href="profile1.php"><i class="fa fa-folder-open	"></i></a></li>
                ...
                <div class="card card1">
                    <div class="box1 b2">
                        <img src="/images/Pure-mathematics-formulæ-blackboard.jpg" alt="">
                        <h3 class="title">MP</h3>
                        <ul class="icon">
                            <li><a href="profile2.php"><i class="fa fa-folder-open	"></i></a></li>
                ...
                <div class="card card1">
                    <div class="box1 b3">
                        <img src="/images/iStock_000068736507_Double-e1455718090681.jpg" alt="">
                        <h3 class="title">PT</h3>
                        <ul class="icon">
                            <li><a href="profile3.php"><i class="fa fa-folder-open	"></i></a></li>
